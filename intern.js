...
button.addEventListener("click", function (e) {
  ...
  fetch(url, {
    ...
    for (var i = 0; i < response.items.length; i++) {
      var _url = response.items[i].clone_url;
      tags += '<div class="owner_name">' + response.items[i].owner.login + '</div>' + ("<a href=" + _url + ">" + _url + "</a>") + ("<div class=\"star\">\u30B9\u30BF\u30FC\u6570\uFF1A" + response.items[i].stargazers_count + "</div>");
    }
    elem.innerHTML = tags;
  });
});
